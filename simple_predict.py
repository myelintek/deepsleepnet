...
tf.app.flags.DEFINE_integer('num_subjects', 20,
                           """specify number of subject to be predict.""")
...
def _run_epoch(sess, network, inputs, targets, train_op, is_train, output_dir, subject_idx):
	start_time = time.time()
	y = []
	y_true = []
	total_loss, n_batches = 0.0, 0
